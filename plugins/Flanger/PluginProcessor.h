...
public:
    ...
    const juce::String getName() const override { return "OP Flanger"; }
    ...
    static constexpr Preset presets[] = {
        { "Classic Jet",   0.30f, 0.60f, 0.70f, 0.50f },
        { "Gentle Sweep",  0.15f, 0.30f, 0.30f, 0.40f },
        { "Through Zero",  0.10f, 0.90f, 0.85f, 0.50f },
        { "Metallic",      0.50f, 0.50f, 0.90f, 0.60f },
        { "Psychedelic",   1.50f, 0.80f, 0.75f, 0.55f },
    };
