...
public:
    ...
    const juce::String getName() const override { return "OP Tuner"; }
    ...
    //==============================================================================
    // Factory presets
    struct Preset { const char* name; float mute, level; };

    static constexpr Preset presets[] = {
        // Pass Through: signal passes with full level
        { "Pass Through", 0.0f, 1.0f },
        // Muted: silence output for tuning with a hardware tuner
        { "Muted",        1.0f, 1.0f },
    };
